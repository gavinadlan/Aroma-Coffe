        ...
        <div className="flex flex-col md:flex-row gap-6 mb-12">
          ...
          <div className="flex flex-wrap gap-2">
            {categories.map((category) => (
              <button
                key={category}
                className="px-4 py-2 text-sm rounded-full border border-amber-700 text-amber-700 hover:bg-amber-700 hover:text-white transition-all duration-300"
              >
                {category}
              </button>
            ))}
          ...
          <div className="bg-gradient-to-r from-stone-900 to-amber-900 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 lg:p-12 text-white">
                ...
                <h2 className="font-playfair text-3xl lg:text-4xl font-bold mb-4">{blogPosts[0].title}</h2>
                <p className="text-stone-200 mb-6 leading-relaxed">{blogPosts[0].excerpt}</p>
              ...
              <div className="h-64 lg:h-auto">
                <div className="w-full h-full bg-stone-700 flex items-center justify-center">
                  <span className="text-stone-400">Gambar Artikel Unggulan</span>
                </div>
              </div>
            </div>
          </div>
